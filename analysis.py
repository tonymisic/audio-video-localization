...
for val in info_test:
    ...
    background += 10 - (end - start)
    total += 10
print("In testing set there is " + str(round(event / total * 100, 2)) + "% events and " + str(round(background / total * 100, 2)) + "% background.")
...
for val in info_val:
    ...
    background += 10 - (end - start)
    total += 10
print("In validation set there is " + str(round(event / total * 100, 2)) + "% events and " + str(round(background / total * 100, 2)) + "% background.")